package com.ozgegn.easyclipping
...
class ClippingView @JvmOverloads constructor(
    ...
    private fun drawClippedRectangle(canvas: Canvas) {
        ...
        //Paint all of the canvas to white. Because we're not drawing a rectangle we're clipping it
    ...
    //The quickReject() method allows you to check whether a specified
    //rectangle or path would lie completely outside the currently visible regions, after all transformations have been applied
